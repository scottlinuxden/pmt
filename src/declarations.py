...
def define_tables():
	...
	'po' : { \
		...
		'required' : 1, \
		'validation_routine' : 'checkBlankField', \
		'validation_arguments': ['form.po_status', "'PO Status'"], \
		'leaveFocus' : None, \
		'gainFocus' : "displayHint('PO Status')" \
		}, \
	    'billing_address' : { \
	...
	#	}, \'''
	    ...
	    'direct_project_charge_number2' : { \
		'label' : 'Direct Project Charge Number (2)', \
		'type': 'VARCHAR', \
		'db_size' : '14', \
		'form_size' : '14', \
		'default' : None, \
		...
		'display_order' : 27, \
		'validation_routine' : 'valid_format', \
		'validation_arguments' : ["form.direct_project_charge_number2", "'####-###-##-##'", "'Direct Project Charge Number (2)'", 0], \
		'leaveFocus' : None, \
		'gainFocus' : "displayHint('Direct Project Charge Number')", \
		'format' : "####-###-##-##" \
		}, \
	    'direct_project_charge_amount2' : { \
		'label' : 'Direct Project Charge Amount (2)', \
		'type': 'VARCHAR', \
		'db_size' : '14', \
		'form_size' : '14', \
		'default' : None, \
		...
		'display_order' : 28, \
		'validation_routine' : 'checkLength', \
		'validation_arguments': ['form.direct_project_charge_amount2', 14,  "'Direct Project Charge Amount (2)'", 0], \
		'leaveFocus' : None, \
		'gainFocus' : "displayHint('Direct Project Charge Amount')" \
		}, \
	    'direct_ra_username' : { \
		...
		'gainFocus' : "displayHint('Indirect Project Charge Amount')" \
            ...
            'indirect_proj_charge_number2' : { \
		'label' : 'Indirect Project Charge Number (2)', \
		'type': 'VARCHAR', \
		'db_size' : '14', \
		'form_size' : '14', \
		'default' : None, \
		...
		'display_order' : 36, \
		'validation_routine' : 'valid_format', \
		'validation_arguments' : ["form.indirect_proj_charge_number2", "'##-####-###'", "'Indirect Project Charge Number (2)'", 0], \
		'leaveFocus' : None, \
		'gainFocus' : "displayHint('Indirect Project Charge Number')", \
		'format' : "##-####-###" \
		}, \
	    'indirect_proj_charge_amount2' : { \
		'label' : 'Indirect Project Charge Amount (2)', \
		'type': 'VARCHAR', \
		'db_size' : '14', \
		'form_size' : '14', \
		'default' : None, \
		...
		'display_order' : 37, \
		'validation_routine' : 'checkLength', \
		'validation_arguments': ['form.indirect_proj_charge_amount2', 14,  "'Indirect Project Charge Amount (2)'", 0], \
		'leaveFocus' : None, \
		'gainFocus' : "displayHint('Indirect Project Charge Amount')" \
		}, \
	...
	'priviledges' : { \
	    ...
	    'del_docs' : { \
		'label' : 'Delete from File Exchange', \
		'type' : 'BOOL', \
		'db_size' : '6', \
		'form_size' : '6', \
		'default' : 'f', \
	    ...
	    'list_docs' : { \
		'label' : 'View/Download File Exchange', \
		'type' : 'BOOL', \
		'db_size' : '6', \
		'form_size' : '6', \
		'default' : 'f', \
	    ...
	    'folder_admin' : { \
		'label' : 'Create/Delete File Exchange Folders', \
		'type' : 'BOOL', \
		'db_size' : '6', \
		'form_size' : '6', \
		'default' : 'f', \
	    ...
	    'private_data' : { \
		'label' : 'View Private File Exchange Areas', \
		'type' : 'BOOL', \
		'db_size' : '6', \
		'form_size' : '6', \
		'default' : 'f', \
	    ...
	    'edit_details' : { \
		'label' : 'Edit Details in File Exchange', \
		'type' : 'BOOL', \
		'db_size' : '6', \
		'form_size' : '6', \
		'default' : 'f', \

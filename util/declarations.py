...
pmt_info = {}
pmt_info['db_name'] = 'pmtdemo'
pmt_info['domain_name'] = 'www.wavefish.org'
pmt_info['browser_username'] = 'pmtdemo'
pmt_info['browser_password'] = 'pmt1demo'
pmt_info['help_file'] = 'help.html'

def table_privileges():
    all_privs=['SELECT','INSERT','UPDATE','DELETE']
    seq_privs=['ALL']
    privileges = { \
	'action_item_types' :    { pmt_info['browser_username'] : all_privs },
	'categories' :           { pmt_info['browser_username'] : all_privs },
	'dispositions' :         { pmt_info['browser_username'] : all_privs },
	'ecp' :                  { pmt_info['browser_username'] : all_privs }, 
	'ecp_prefixes' :         { pmt_info['browser_username'] : all_privs },
	'ecp_statuses' :         { pmt_info['browser_username'] : all_privs },
	'ecp_types' :            { pmt_info['browser_username'] : all_privs },
	'inventory' :            { pmt_info['browser_username'] : all_privs },
	'member_roles' :         { pmt_info['browser_username'] : all_privs },
	'pai' :                  { pmt_info['browser_username'] : all_privs }, 
	'po' :                   { pmt_info['browser_username'] : all_privs },
	'po_line_item' :         { pmt_info['browser_username'] : all_privs },
	'po_payment_method' :    { pmt_info['browser_username'] : all_privs },
	'priviledges' :          { pmt_info['browser_username'] : all_privs },
	'problem_duplications' : { pmt_info['browser_username'] : all_privs },
	'project_info' :         { pmt_info['browser_username'] : all_privs }, 
	'project_members' :      { pmt_info['browser_username'] : all_privs }, 
	'shipping_addresses':    { pmt_info['browser_username'] : all_privs }, 
	'signature_functions' :  { pmt_info['browser_username'] : all_privs },
	'spr' :                  { pmt_info['browser_username'] : all_privs }, 
	'spr_categories' :       { pmt_info['browser_username'] : all_privs },
	'spr_prefixes' :         { pmt_info['browser_username'] : all_privs },
	'spr_priorities' :       { pmt_info['browser_username'] : all_privs },
	'spr_statuses' :         { pmt_info['browser_username'] : all_privs },
	'task' :                 { pmt_info['browser_username'] : all_privs }, 
	'us_states' :            { pmt_info['browser_username'] : all_privs },
	'ecp_id_seq' :           { pmt_info['browser_username'] : seq_privs }, 
	'pai_id_seq' :           { pmt_info['browser_username'] : seq_privs }, 
	'project_id_seq' :       { pmt_info['browser_username'] : seq_privs }, 
	'project_members_id_seq':{ pmt_info['browser_username'] : seq_privs }, 
	'spr_id_seq' :           { pmt_info['browser_username'] : seq_privs }, 
	'task_id_seq' :          { pmt_info['browser_username'] : seq_privs }, 
	}
...
def define_tables():
	...
	'inventory' : { \
		...
		'validation_arguments': ['form.unit_price',"''", "'Unit Price'", 1], \
		'leaveFocus' : None, \
		...
		'required' : 1, \
		'validation_routine' : 'valid_money', \
		'validation_arguments': ['form.total_unit_price',"''", "'Total Unit Price'", 1], \
		'leaveFocus' : None, \
	...
	'po' : { \
		...
		'required' : 1, \
		'validation_routine' : 'valid_money', \
		'validation_arguments': ['form.amount_requested', "''", "'Amount Requested'", 1], \
		'leaveFocus' : None, \
	...
	#	}, \'''
		...
		'required' : 1, \
		'validation_routine' : 'checkBlankField', \
		'validation_arguments' : ['form.vendor_name', "'Vendor Name'"], \
		'leaveFocus' : None, \
		'gainFocus' : "displayHint('Enter Vendor Name')" \
		}, \
	    'vendor_address' : { \
		...
		'display_order' : 16, \
		'leaveFocus' : None, \
		'gainFocus' : "displayHint('Enter Vendor Address')" \
		}, \
		...
		'display_order' : 17, \
		'leaveFocus' : None, \
		'gainFocus' : "displayHint('Enter Vendor City, State, Zip')" \
		}, \
	    'vendor_contact' : { \
		'label' : 'Contact', \
		'type' : 'VARCHAR', \
		...
		'display_order' : 18, \
		'leaveFocus' : None, \
		'gainFocus' : "displayHint('Enter Vendor Contact')" \
		}, \
	    'vendor_phone' : { \
		'label' : 'Phone', \
		'type' : 'VARCHAR', \
		...
		'display_order' : 19, \
		'validation_routine' : 'valid_format', \
		'validation_arguments' : ["form.vendor_phone","'###-###-####'","'Daytime Phone Number'", "false"], \
		'leaveFocus' : None, \
		'gainFocus' : "displayHint('Enter Vendor Phone Number)", \
		'format' : "###-###-####" \
		}, \
	    'vendor_fax' : { \
		'label' : 'FAX', \
		...
		'display_order' : 20, \
		'validation_routine' : 'valid_format', \
		'validation_arguments' : ["form.vendor_fax","'###-###-####'","'Daytime FAX Number'", "false"], \
		'leaveFocus' : None, \
		'gainFocus' : "displayHint('Enter Vendor FAX Number)", \
		'format' : "###-###-####" \
		}, \
	    'subtotal' : { \
		'label' : 'Subtotal', \
		...
		'display_order' : 74, \
		'validation_routine' : 'checkLength', \
		'validation_arguments': ['form.check_amount', 12,  "'Check Amount'", 0], \
		'leaveFocus' : None, \
		'gainFocus' : "displayHint('Check Amount')" \
		}, \
	    'check_mailed_date' : { \
		'label' : 'Check Mailed Date', \
		'type': 'DATE', \
		'db_size' : '10', \
		'form_size' : '10', \
		'default' : None, \
		...
		'display_order' : 75, \
		'validation_routine' : 'valid_date', \
		'validation_arguments' : ["form.check_mailed_date", "'Check Mailed Date'", 0], \
		'leaveFocus' : None, \
		'gainFocus' : "displayHint('Check Mailed Date')", \
		'format' : "MM-DD-YYYY", \
		}, \
